...
set(TOOLCHAIN_OBJCOPY "${TOOLCHAIN_HOST}-objcopy")
...
# Define vc4 assembler
set(VC4ASM "/root/vc4asm/build/vc4asm")
set(VC4_TOOLPATH "/root/vc4-toolchain/prefix/bin/")
...
string(JOIN " " COMMON_FLAGS
    ...
    "-I${SYSROOT_PATH}/usr/include/arm-linux-gnueabihf"
    # "-I${SYSROOT_PATH}/opt/vc/include"
    # "-I${SYSROOT_PATH}/opt/vc/include/EGL"
    # "-I${SYSROOT_PATH}/opt/vc/include/interface/vcsm"
)
